"""
Django settings for didata project.
...
SECRET_KEY = 'rw5zcw0pf18kcd&(pe4u12#mxprw*h=h7j1(sc34yi*$5!zzdc'
...
WSGI_APPLICATION = 'didata.wsgi.application'
